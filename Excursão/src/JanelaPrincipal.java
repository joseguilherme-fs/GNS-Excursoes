...
public class JanelaPrincipal {
	...
	private void initialize() {
		...
		InputStream fontStream2 = apgExcursao.class.getResourceAsStream("/Fontes/taileb.ttf");
		...
		try {
		    ...
		    font2 = font2.deriveFont(Font.BOLD, 22); //
		...
		JanelaRE = new JFrame();
		JanelaRE.setIconImage(Toolkit.getDefaultToolkit().getImage(JanelaPrincipal.class.getResource("/Imagens/icone2.png")));
		...
		ReservasP.setBounds(0, 0, 668, 502);
		...
		textAreaListarR.setLocation(454, 0);
		...
		btnCriarR.setBackground(SystemColor.scrollbar);
		...
		lblNewLabel_3_1.setForeground(new Color(139, 69, 19));
		lblNewLabel_3_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_3_1.setFont(font2);
		...
		btnListarR.setBackground(SystemColor.scrollbar);
		...
		valorTotal.setForeground(new Color(139, 0, 0));
		valorTotal.setHorizontalAlignment(SwingConstants.LEFT);
		valorTotal.setFont(font2);
		...
		btnCriar.setBackground(SystemColor.scrollbar);
		...
		btnRecuperar.setBackground(SystemColor.scrollbar);
		...
		btnMostrarValor.setForeground(Color.BLACK);
		btnMostrarValor.setBackground(SystemColor.scrollbar);
		btnMostrarValor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (excursao == null) {
					respC.setText("Crie ou recupere uma excursão antes!");
				}
				else {
					labelValor.setText("");
					respC.setText("");
		...
		btnReservas.setBounds(538, 26, 102, 23);
		...
		btnExcursoes.setBounds(538, 26, 102, 23);
		...
		btnCancelarR.setBackground(SystemColor.scrollbar);
